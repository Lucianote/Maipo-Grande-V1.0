        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card-border-primary">
              ...
              <div class="card-body">
                ...
                <p class="card-text"><strong>Precio (USD):</strong><?php echo $row['precio'] ?></p>
                <p class="card-text"><strong>Stock:</strong> <?php echo $row['existencia'] ?></p>
                <a href="index.php?modulo=detalleproducto&id=<?php echo $row['id'] ?>"  class="btn btn-primary ">Ver Mas</a>
