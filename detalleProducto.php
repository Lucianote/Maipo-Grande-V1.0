    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                ...
                <p>Todos los productos ofrecidos en nuestro portal son 100% naturales libres de insecticidas y quimicos. </p>


                <h4 class="mt-3">Envio: <small>Tarifas de envio de los transportistas no estan consideradas en el precio del producto.</small></h4>

                <hr>
                <h4>Stock: <?php echo $rowProducto['existencia'] ?></h4>
                <div class="bg-gray py-2 px-3 mt-4">
                    <h2 class="mb-0">
                       $<?php echo $rowProducto['precio'] ?>.00 (USD)
                    </h2>
                </div>
